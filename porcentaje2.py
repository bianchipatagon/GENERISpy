...
ax.scatter(porc['capacidad'],porc['alt'],color='#A1150B',marker = 'D',s=60,label='alternativo', alpha = 0.1)
ax.scatter(porc['capacidad'],porc['altMH'],color='#207653',marker = 'D',s=60,label='manejo hidro')
...
plt.savefig('porc2.svg', dpi=300, bbox_inches="tight")
