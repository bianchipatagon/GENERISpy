...
axs[0].plot(fu_dry['hora'],fu_dry['rositas'],color='#A1150B',linewidth=2.5,label='actual')
axs[0].plot(fu_dry['hora'],fu_dry['rositasaj'],color='#207653',linewidth=2.5,label='propuesta')
...
axs[1].plot(fu_wet['hora'],fu_wet['rositas'],color='#A1150B',linewidth=2.5,label='actual')
axs[1].plot(fu_wet['hora'],fu_wet['rositasaj'],color='#207653',linewidth=2.5,label='propuesta')
...
plt.savefig('fuROS.svg', dpi=300, bbox_inches="tight")
