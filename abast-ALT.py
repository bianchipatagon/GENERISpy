...
ALTGD = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/abastALTGD.txt', header=0, delimiter=';', na_values='-999',index_col='hora')

ALT['ImpoN'] = -ALT['ImpoN']
ALT['ImpoC'] = -ALT['ImpoC']
ALT['ImpoC2'] = -ALT['ImpoC2']
ALT['ImpoO'] = -ALT['ImpoO']
ALT['ImpoS'] = -ALT['ImpoS']
print(ALTGD['ImpoN'])
print(ALTGD['ImpoC'])
ALTGD['ImpoN'] = - ALTGD['ImpoN'] - ALT['ImpoN']
ALTGD['ImpoC'] = - ALTGD['ImpoC'] - ALT['ImpoC2']
...
plt.savefig('abastALT.jpg', dpi=300, bbox_inches="tight")
