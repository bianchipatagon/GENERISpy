...
ALT = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/abastTEN.txt', header=0, delimiter=';', na_values='-999',index_col='hora')
ALTGD = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/abastTENGD.txt', header=0, delimiter=';', na_values='-999',index_col='hora')

ALTGD['FosilO'] = -ALTGD['FosilO']
...
fig, axs = plt.subplots(2,4,figsize=(18,6), sharey='row', sharex=True)
...
axs[1,0].set_xticks(range(0, len(ALT.index), 2))
axs[1,0].set_xticklabels(ALT.index[::2])
axs[1,0].axhline(linewidth=1, color='black', label='_nolegend_')
...
axs[1,1].set_xticks(range(0, len(ALT.index), 2))
axs[1,1].set_xticklabels(ALT.index[::2])
axs[1,1].axhline(linewidth=1, color='black', label='_nolegend_')
...
axs[1,2].set_xticks(range(0, len(ALT.index), 2))
axs[1,2].set_xticklabels(ALT.index[::2])
axs[1,2].axhline(linewidth=1, color='black', label='_nolegend_')
...
axs[1,3].set_xticks(range(0, len(ALT.index), 2))
axs[1,3].set_xticklabels(ALT.index[::2])
axs[1,3].axhline(linewidth=1, color='black', label='_nolegend_')
...
plt.savefig('abastTEN.jpg', dpi=300, bbox_inches="tight")
