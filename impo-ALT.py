...
fig, axs = plt.subplots(3,3,figsize=(16,8), sharey='row', sharex=True)
...
##positivos
axs[1,0].bar(RESTA1.index, RESTA1['impoC30'], color='#FBAA1B', alpha=0.8)
axs[1,0].bar(RESTA1.index, RESTA1['impoN30'], bottom=RESTA1['impoC30'], color='#207653', alpha=0.8)
axs[1,0].bar(RESTA1.index, RESTA1['impoO30'], bottom=RESTA1['impoC30']+RESTA1['impoN30'], color='#8FC73E', alpha=0.8)
axs[1,0].bar(RESTA1.index, RESTA1['impoS30'], bottom=RESTA1['impoC30']+RESTA1['impoN30']+RESTA1['impoO30'], color='#A1140B', alpha=0.8)
...
################### 2040
##positivos
axs[1,1].bar(RESTA1.index, RESTA1['impoC40'], color='#FBAA1B', alpha=0.8)
axs[1,1].bar(RESTA1.index, RESTA1['impoN40'], bottom=RESTA1['impoC40'], color='#207653', alpha=0.8)
axs[1,1].bar(RESTA1.index, RESTA1['impoO40'], bottom=RESTA1['impoC40']+RESTA1['impoN40'], color='#8FC73E', alpha=0.8)
axs[1,1].bar(RESTA1.index, RESTA1['impoS40'], bottom=RESTA1['impoC40']+RESTA1['impoN40']+RESTA1['impoO40'], color='#A1140B', alpha=0.8)
...
################### 2050
##positivos
axs[1,2].bar(RESTA1.index, RESTA1['impoC50'], color='#FBAA1B', alpha=0.8)
axs[1,2].bar(RESTA1.index, RESTA1['impoN50'], bottom=RESTA1['impoC50'], color='#207653', alpha=0.8)
axs[1,2].bar(RESTA1.index, RESTA1['impoO50'], bottom=RESTA1['impoC50']+RESTA1['impoN50'], color='#8FC73E', alpha=0.8)
axs[1,2].bar(RESTA1.index, RESTA1['impoS50'], bottom=RESTA1['impoC50']+RESTA1['impoN50']+RESTA1['impoO50'], color='#A1150B', alpha=0.8)
...
################### 2030
##positivos
axs[2,0].bar(RESTA2.index, RESTA2['impoC30'], color='#FBAA1B', alpha=0.8)
axs[2,0].bar(RESTA2.index, RESTA2['impoN30'], bottom=RESTA2['impoC30'], color='#207653', alpha=0.8)
axs[2,0].bar(RESTA2.index, RESTA2['impoO30'], bottom=RESTA2['impoC30']+RESTA2['impoN30'], color='#8FC73E', alpha=0.8)
axs[2,0].bar(RESTA2.index, RESTA2['impoS30'], bottom=RESTA2['impoC30']+RESTA2['impoN30']+RESTA2['impoO30'], color='#A1140B', alpha=0.8)
...
################### 2040
##positivos
axs[2,1].bar(RESTA2.index, RESTA2['impoC40'], color='#FBAA1B', alpha=0.8)
axs[2,1].bar(RESTA2.index, RESTA2['impoN40'], bottom=RESTA2['impoC40'], color='#207653', alpha=0.8)
axs[2,1].bar(RESTA2.index, RESTA2['impoO40'], bottom=RESTA2['impoC40']+RESTA2['impoN40'], color='#8FC73E', alpha=0.8)
axs[2,1].bar(RESTA2.index, RESTA2['impoS40'], bottom=RESTA2['impoC40']+RESTA2['impoN40']+RESTA2['impoO40'], color='#A1140B', alpha=0.8)
...
################### 2050
##positivos
axs[2,2].bar(RESTA2.index, RESTA2['impoC50'], color='#FBAA1B', alpha=0.8)
axs[2,2].bar(RESTA2.index, RESTA2['impoN50'], bottom=RESTA2['impoC50'], color='#207653', alpha=0.8)
axs[2,2].bar(RESTA2.index, RESTA2['impoO50'], bottom=RESTA2['impoC50']+RESTA2['impoN50'], color='#8FC73E', alpha=0.8)
axs[2,2].bar(RESTA2.index, RESTA2['impoS50'], bottom=RESTA2['impoC50']+RESTA2['impoN50']+RESTA2['impoO50'], color='#A1150B', alpha=0.8)
...
fig.text(0.91, 0.49, 'ALTGD - ALT', va='center' ,fontsize=16, weight='bold', rotation='vertical')  
