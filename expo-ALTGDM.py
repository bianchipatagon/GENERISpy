...
fig, axs = plt.subplots(1,3,figsize=(16,3), sharey='row', sharex=True)
'''
#################### ALT ###############################
################### 2030
...
axs[0,0].bar(ALT.index, ALT['expoS30'], bottom=ALT['expoC30']+ALT['expoN30']+ALT['expoO30'], color='#A1140B', alpha=0.8)
...
################### 2040
axs[0,1].set_title('Exportaciones \n 2040', fontsize = 16, weight = 'bold')
##positivos
...
axs[0,1].bar(ALT.index, ALT['expoS40'], bottom=ALT['expoC40']+ALT['expoN40']+ALT['expoO40'], color='#A1140B', alpha=0.8)
...
axs[0,2].bar(ALT.index, ALT['expoS50'], bottom=ALT['expoC50']+ALT['expoN50']+ALT['expoO50'], color='#A1150B', alpha=0.8)
...
for col, color in zip(cols, colors):
    # Plot positive part
    axs[0].bar(RESTA2.index, pos_data[col], bottom=pos_bottoms,
                 color=color, alpha=0.8)
    pos_bottoms += pos_data[col].values

    # Plot negative part
    axs[0].bar(RESTA2.index, neg_data[col], bottom=neg_bottoms,
                 color=color, alpha=0.8)
    neg_bottoms += neg_data[col].values

axs[0].set_ylim(-400, 400)
axs[0].set_title('2030', fontsize = 16, weight = 'bold')
axs[0].set_xticks(range(0, len(RESTA2.index), 2))
axs[0].set_xticklabels(RESTA2.index[::2])
...
for col, color in zip(cols, colors):
    # Plot positive part
    axs[1].bar(RESTA2.index, pos_data[col], bottom=pos_bottoms,
                 color=color, alpha=0.8)
    pos_bottoms += pos_data[col].values

    # Plot negative part
    axs[1].bar(RESTA2.index, neg_data[col], bottom=neg_bottoms,
                 color=color, alpha=0.8)
    neg_bottoms += neg_data[col].values
    
axs[1].set_title('Exportaciones \n 2040', fontsize = 16, weight = 'bold')
axs[1].set_xticks(range(0, len(RESTA2.index), 2))
axs[1].set_xticklabels(RESTA2.index[::2])
...
for col, color in zip(cols, colors):
    # Plot positive part
    axs[2].bar(RESTA2.index, pos_data[col], bottom=pos_bottoms,
                 color=color, alpha=0.8)
    pos_bottoms += pos_data[col].values

    # Plot negative part
    axs[2].bar(RESTA2.index, neg_data[col], bottom=neg_bottoms,
                 color=color, alpha=0.8)
    neg_bottoms += neg_data[col].values
    
axs[2].set_title('2050', fontsize = 16, weight = 'bold')
axs[2].set_xticks(range(0, len(RESTA2.index), 2))
axs[2].set_xticklabels(RESTA2.index[::2])
...
plt.savefig('expoALTGDM.jpg', dpi=300, bbox_inches="tight")
