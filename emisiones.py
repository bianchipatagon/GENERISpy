...
ax1.bar(emis['año'], emis['tend'], color='#A1140B',alpha=0.8)
ax1.set_ylim(-800, 0)
ax1.yaxis.set_tick_params(labelsize=16)
ax1.xaxis.set_tick_params(labelsize=16, rotation=90)
ax1.set_ylabel('10^3 CO$_2$e', fontsize=16)
ax1.set_xticks([2025,2030,2035,2040,2045,2050], ['2025','2030','2035','2040','2045','2050'])
ax1.set_title('TEND', fontsize=16, fontweight='bold')
ax1.set_xlim(2024.5, 2050.5)

ax2.bar(emis['año'], emis['alt'], color='#A1140B',alpha=0.8)
ax2.set_ylim(-800, 0)
