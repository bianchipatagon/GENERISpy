...
emis = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/ahorroGDM.txt', header=0, delimiter=',', na_values='-99')
print(emis)

fig, ax = plt.subplots(1,1,figsize=(5, 3), sharey=True)

ax.bar(emis['anio'], emis['alt'], color='#A1140B')
ax.set_ylim(-1000, 0)
ax.yaxis.set_tick_params(labelsize=16)
ax.xaxis.set_tick_params(labelsize=16, rotation=90)
ax.set_ylabel('10^3 BEP', fontsize=16)
...
plt.savefig('ahorroGDM.svg', dpi=300, bbox_inches="tight")
