...
potencia = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/generacionALTGDM.txt', header=0, delimiter=';', na_values='-999')
print(potencia)
...
ax.pie(potencia['altGDM'], colors=colors,autopct='%1.1f%%', startangle=90, radius=1.3,wedgeprops=dict(width=0.98, edgecolor='white'),labeldistance=1.1,textprops=dict(color="black", fontsize=16), hatch=hatch_patterns)
ax.set_title('2050 (22122 GWh)', fontsize=24, fontweight='bold')
ax.set_title('Escenario Alternativo \n Manejo H. 2050 (22410 GWh)', fontsize=24, fontweight='bold')
ax.legend(labels,  loc="center left", bbox_to_anchor=(1, 0, 0.5, 1), fontsize=16, frameon=False)
...
plt.savefig('GENERACION-ALTGDM.svg', dpi=300, bbox_inches="tight")
