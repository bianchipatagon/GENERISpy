...
potencia = pd.read_csv('/home/emi/Documents/GENERIS/GENERISpy/potencia.txt', header=0, delimiter=';', na_values='-999')
print(potencia)
...
gs = GridSpec(1,5, figure=fig, width_ratios=[1,1.063,1.152,1.269,1.346])
...
ax1.set_title('2025 (4520 MW)', fontsize=24, fontweight='bold')
...
ax2.set_title('TEN \n 2050 (5250 MW)', fontsize=24, fontweight='bold')
...
ax3.set_title('TEN-GD \n 2050 (6154 MW)', fontsize=24, fontweight='bold')
...
ax4.set_title('ALT \n 2050 (7286 MW)', fontsize=24, fontweight='bold')
...
ax5.set_title('ALT-GD \n 2050 (8186 MW)', fontsize=24, fontweight='bold')
ax5.legend(labels,  loc="center left", bbox_to_anchor=(1, 0, 0.5, 1), fontsize=16, frameon=False)

plt.savefig('POTENCIA.svg', dpi=300, bbox_inches="tight")
