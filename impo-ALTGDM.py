...
# ~ fig.text(0.91, 0.5, 'ALTGD - ALT', va='center' ,fontsize=16, weight='bold', rotation='vertical')  
...
plt.savefig('impoALTGDM.jpg', dpi=300, bbox_inches="tight")
